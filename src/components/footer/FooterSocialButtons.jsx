...
/** Uniform icons — white on purple circles */
const SOCIAL_SVGS = {
  linkedin: (
  ...
  facebook: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M13.5 9.5V7.7c0-.8.6-1 1-.9h1.5V4h-2.1C12.5 4 11 5.5 11 7.5v2H9v2.6h2V20h2.5v-10.4H16l.4-2.6h-2.9z" />
    </svg>
  ),
};
    ...
    <div className={rowClass} role="list">
      {SOCIAL_LINKS.map((social) => (
        <a
          ...
          role="listitem"
          className={`footer-social-3d${isContact ? ' footer-social-3d--lg' : ''}`}
        >
